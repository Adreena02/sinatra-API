...
10.times do
    Flight.create(airline_name: airline_names.sample, departure: Faker::Date.between(from: Date.today, to: "2021-07-19"), arrival: Faker::Date.between(from: Date.today, to: "2021-07-19"), flight_num: rand(150..300), max_cap: rand(45..70), destination: Faker::Fantasy::Tolkien.location)
end
